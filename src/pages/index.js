...
import {
  Link as ScrollLink, Element, Events, animateScroll as scroll, scrollSpy, scroller,
} from 'react-scroll';
...
>>>>>>> fe506c5e5a8a816e79cc54ba7203f1d08e202c73
        <div className="ss_footer_row">
        ...
        <div className="ss_footer_row" style={{textAlign: 'center'}}>
          <a href="https://opensource.org/licenses/MIT" target="_blank">
            <img src={require('../static/openi.png')} style={{width: 65, marginTop: '1.1rem'}}/>
          </a>
        </div>
      </div>
    );
        ...
        <div className="ss_h_s_credits">
          ...
          <CreditsGroup
            ...
            title={(
              <>
Agradecimientos
                <span>(En las equivalencias de términos empresariales)</span>
              </>
)}
          />
        </div>
    ...
    return (
      <div className={cs.join(' ')}>
        ...
        <div className="ss_h_s_credits_group_container">
          {this.props.g.map((e) => <CreditsPerson e={e} />)}
        </div>
      </div>
    );
  }
  ...
  render() {
    const points = [
      ...
      },
      {
        ...
        content: <>
Sinapsis es un proyecto de código abierto, ayúdanos a mantenerlo y contribuye a través de
          <a href="https://github.com/animalpolitico/sinapsis" target="_blank">nuestro repositorio</a>
.
                 </>,
        // link: {
        ...
        contentPoints: [
          {
            title: 'Código',
            content: <>
Sinapsis es código abierto, si quieres colaborar a nivel de programación y desarrollo puedes hacerlo en nuestro
              <a href="https://github.com/animalpolitico/sinapsis" target="_blank">repo de GitHub</a>
            </>,
          },
          {
            title: 'Bases de datos',
            content: <>
Si tienes alguna base pública que no esté cargada envíala a
          ...
          },
          {
            title: 'Casos de uso',
            content: <>
¿Usaste Sinapsis para alguna investigación?, cuéntanos cómo fue tu experiencia por
              <a href="mailto:hola@sinapsis.lat">correo</a>
              {' '}
o en nuestro
              <a href="http://t.me/sinapsislat" target="_blank">grupo de Telegram</a>
                     </>,
          },
        ],
      },
            ...
            d.contentPoints
              ? (
                <div className="ss_h_subpoints">
                  {
                d.contentPoints.map((p, i) => (
                  <div className="ss_h_subpoints_p">
                    <div className="ss_h_subpoints_p_t">
                      <span>{`${i + 1}.`}</span>
                      {p.title}
                    </div>
...
Herramienta para descubrir
            <br />
            <strong>conexiones entre empresas</strong>
          </div>
      ...
      <div className="ss_h_s" id="ss_h_video">
        <a href="https://www.youtube.com/watch?reload=9&v=PT3UGsBkPfI&feature=youtu.be" target="_blank">
          <div className="ss_h_s_video">
            <div className="ss_h_s_video_ball" />
    ...
    return (
      <div className="ss_h_s" id="ss_h_landing">
        <div className="ss_h_s_c">
          ...
          <ScrollLink to="video" smooth offset={-100}>
